...
require('lazy').setup({
  ...
  { 'echasnovski/mini.ai', version = false, opts = {} },
  {
    ...
    keys = {
      { '<leader>sr', function() require('grug-far').open() end, desc = 'Search and Replace (Grug)' },
    },
  },
  {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        --
        defaults = {
          -- Mejorar visualización de rutas largas
          path_display = { 'smart' }, -- Trunca inteligentemente mostrando el nombre del archivo
          -- Alternativas:
          -- 'truncate' - Trunca desde la izquierda, prioriza el nombre
          -- { 'shorten', length = 3 } - Acorta directorios: /u/d/C/fury_flox-android/...
          -- 'tail' - Solo muestra el nombre del archivo (sin ruta)

          -- Layout más ancho para ver mejor los nombres
          layout_config = {
            horizontal = {
              preview_width = 0.55,
              results_width = 0.45,
  ...
  },
  {
    ...
    config = function()
      ...
      vim.g.deprecate_lspconfig_warning = false
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Restart LSP (útil cuando kotlin-lsp tiene errores)
      ...
      local servers = {
        ...
        kotlin_language_server = {
          ...
          filetypes = { 'kotlin' },
          root_dir = require('lspconfig').util.root_pattern('settings.gradle', 'settings.gradle.kts', 'build.gradle', 'build.gradle.kts'),
          -- Aumentar timeout para proyectos grandes
          flags = {
          ...
          on_attach = function(client, bufnr)
            ...
            vim.api.nvim_create_autocmd('LspDetach', {
              buffer = bufnr,
              callback = function()
                vim.notify('Kotlin LSP desconectado. Usa :LspRestart para reiniciar', vim.log.levels.WARN)
              end,
            })
          end,
        },
  ...
  { -- Enhanced markdown rendering in Neovim
    ...
    config = function()
      require('render-markdown').setup {
        -- Enable rendering
        enabled = true,
        -- Maximum file size to render (in KB)
        max_file_size = 1.5,
        ...
        -- Table settings - IMPORTANT for your use case
        pipe_table = {
          enabled = true,
          style = 'full',
          cell = 'padded',
